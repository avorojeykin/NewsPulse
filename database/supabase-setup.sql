-- NewsPulse Supabase Production Setup
-- Combined schema and migrations
...
CREATE TABLE news_items (
    ...
    ticker VARCHAR(20), -- Stock ticker symbol (e.g., AAPL, TSLA)
    title TEXT NOT NULL,
    content TEXT,
    url TEXT,
...
CREATE INDEX idx_users_membership ON users(whop_membership_id);
CREATE INDEX idx_experiences_active ON experiences(active);
CREATE INDEX idx_experiences_tier ON experiences(tier);
...
COMMENT ON COLUMN users.tier IS 'free or premium';
